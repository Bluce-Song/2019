...
static const char qt_meta_stringdata_Widget_DCW[] = {
    ...
    "on_dcwTab_cellChanged(int,int)\0"
    "on_dcwTab_cellClicked(int,int)\0"
...
void Widget_DCW::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_dcwTab_cellChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->on_dcwTab_cellClicked((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
