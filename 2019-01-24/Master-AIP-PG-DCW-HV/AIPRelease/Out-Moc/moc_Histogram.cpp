...
#include "../../AIPDebug/External-Interface/Histogram.h"
...
static const char qt_meta_stringdata_Histogram[] = {
    "Histogram\0\0msg\0setNames(QStringList)\0"
    "setValues(QStringList)\0paintEvent(QPaintEvent*)\0"
};
...
void Histogram::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setNames((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
        case 1: _t->setValues((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
...
const QMetaObject Histogram::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Histogram,
